...
public partial class IntroUi : WindowMediatorSubscriberBase
{
    ...
    public IntroUi(ILogger<IntroUi> logger, UiSharedService uiShared, MareConfigService configService,
        ...
        PerformanceCollectorService performanceCollectorService, DalamudUtilService dalamudUtilService) : base(logger, mareMediator, "XIVSync Setup", performanceCollectorService)
    {
        _uiShared = uiShared;
    ...
    protected override void DrawInternal()
    {
        ...
        if (!_configService.Current.AcceptedAgreement && !_readFirstPage)
        {
            ...
            ImGui.Separator();
            UiSharedService.TextWrapped("XIVSync is a plugin that will replicate your full current character state including all Penumbra mods to other paired XIVSync users. " +
                     ...
                     || !Directory.Exists(_configService.Current.CacheFolder)))
        {
            ...
            {
                UiSharedService.TextWrapped("To not unnecessary download files already present on your computer, XIVSync will have to scan your Penumbra mod directory. " +
                                     "Additionally, a local storage folder must be set where XIVSync will download other character files to. " +
                                     "Once the storage folder is set and the scan complete, this page will automatically forward to registration at a service.");
                UiSharedService.TextWrapped("Note: The initial scan, depending on the amount of mods you have, might take a while. Please wait until it is completed.");
                UiSharedService.ColorTextWrapped("Warning: once past this step you should not delete the FileCache.csv of XIVSync in the Plugin Configurations folder of Dalamud. " +
